export const enUS = {
  ...
  'provider.sdppp_sponsor.description': 'SDPPP sponsor exclusive API',
  'runninghub.error.services_unavailable': 'SDPPPX services are not available',
  'auth.login_hint': 'Please click Login in the top-right corner.',
  'task.running': 'Running...',
  'task.execute': 'Run',
  'task.stop': 'Stop',
  'task.importing_image': 'Importing image {{index}}/{{total}}...',
  'task.error.send_image_failed': 'Failed to send image {{index}}: {{error}}',
  'task.error.failed_status': 'Task failed: {{status}}',
  'taskrouter.template_placeholder': 'Select Banana app...',
  'taskrouter.balance': 'Sponsor Points',
  'taskrouter.recharge': 'Sponsor',
  'taskrouter.refresh_balance': 'Refresh balance',
  'taskrouter.no_schema': 'Please select an app first',
  'taskrouter.config.base_url': 'TaskRouter service URL',
  'taskrouter.config.supabase_url': 'Supabase URL',
  'taskrouter.config.supabase_anon_key': 'Supabase anon key',
  'taskrouter.error.remote_config_missing': 'Missing TaskRouter remote config: {{missing}}. Please check the remote config and try again.',
  'taskrouter.error.client_missing': 'TaskRouter client is not initialized',
  'taskrouter.error.template_missing': 'No task template selected',
  'taskrouter.error.upload_provider_incompatible': 'UploadPassProvider is not fully compatible with TaskRouter upload mechanism. Please use the uploadResource prop instead.',
  'taskrouter.error.deferred_upload_failed': 'Deferred upload failed: {{error}}',
  'taskrouter.error.upload_control_unsupported': 'Upload controls are not supported for TaskRouter',
  'taskrouter.error.upload_resource_missing': 'Missing upload resource',
  'taskrouter.error.tenant_unresolved': 'Failed to resolve tenant information',
  'taskrouter.error.supabase_session_failed': 'Failed to get Supabase session: {{error}}',
  'taskrouter.status.preparing': 'Preparing...',
  'taskrouter.status.uploading': 'Uploading images...',
  'taskrouter.status.validating': 'Validating form...',
  'taskrouter.status.creating': 'Creating task...',
  'taskrouter.tab.editor': 'Run',
  'taskrouter.tab.history': 'History',
  'taskrouter.history.importing': 'Importing history image...',
  'taskrouter.history.send_failed_resource': 'Failed to create file resource',
  'taskrouter.history.send_failed_identifier': 'Invalid resource identifier',
  'taskrouter.history.send_success': 'Image imported to canvas',
  'taskrouter.history.select_prompt': 'Select a history task',
  'taskrouter.history.duration_prefix': 'Duration',
  'taskrouter.history.duration_unit': 'sec',
  'taskrouter.history.createdAt': 'Created At',
  'taskrouter.history.charge': 'Points Spent',
  'taskrouter.history.charge_value': '-{{value}} points',
  'taskrouter.history.images': 'Outputs',
  'taskrouter.history.retry': 'Retry',
  'taskrouter.history.id': 'Task ID',
  'taskrouter.history.message': 'Message',
  'taskrouter.history.no_images': 'No images to preview',
  'taskrouter.history.client_missing': 'TaskRouter client is not initialized',
  'taskrouter.history.limit_notice': 'Only the latest 10 items are available in this version',
  'taskrouter.history.refresh': 'Refresh',
  'taskrouter.history.detail_title': 'Task Details',
  'taskrouter.history.loading': 'Loading history tasks...',
  'taskrouter.history.empty': 'No history tasks',
  'taskrouter.history.started_at_label': 'Started At',
  'taskrouter.history.status.pending': 'Queued',
  'taskrouter.history.status.running': 'Running',
  'taskrouter.history.status.completed': 'Completed',
  'taskrouter.history.status.failed': 'Failed',
  'taskrouter.history.status.cancelled': 'Cancelled',
  ...
  'comfy_simple.prompt_templates.button': 'Presets',
  ...
  'comfy_simple.prompt_templates.modal_title': 'Prompt Presets',
  ...
  'comfy_simple.prompt_templates.search_placeholder': 'Search prompt presets',
  'comfy_simple.prompt_templates.use_button': 'Use Preset',
