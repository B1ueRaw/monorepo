export const zhCN = {
  ...
  'provider.sdppp_sponsor.description': 'SDPPP赞助者专用API',
  'runninghub.error.services_unavailable': 'SDPPPX 服务不可用',
  'auth.login_hint': '请点击右上角登录后使用。',
  'task.running': '运行中...',
  'task.execute': '运行',
  'task.stop': '停止',
  'task.importing_image': '正在导入图片 {{index}}/{{total}}...',
  'task.error.send_image_failed': '发送图片失败 {{index}}: {{error}}',
  'task.error.failed_status': '任务失败：{{status}}',
  'taskrouter.template_placeholder': '选择应用...',
  'taskrouter.balance': '赞助分',
  'taskrouter.recharge': '去赞助',
  'taskrouter.refresh_balance': '刷新余额',
  'taskrouter.no_schema': '请先选择应用',
  'taskrouter.config.base_url': 'TaskRouter 服务地址',
  'taskrouter.config.supabase_url': 'Supabase URL',
  'taskrouter.config.supabase_anon_key': 'Supabase 匿名密钥',
  'taskrouter.error.remote_config_missing': '缺少 TaskRouter 远端配置：{{missing}}。请检查远端配置后重试。',
  'taskrouter.error.client_missing': 'TaskRouter 客户端未初始化',
  'taskrouter.error.template_missing': '未选择任务模板',
  'taskrouter.error.upload_provider_incompatible': 'UploadPassProvider 与 TaskRouter 上传机制不兼容，请改用 uploadResource。',
  'taskrouter.error.deferred_upload_failed': '延迟上传失败: {{error}}',
  'taskrouter.error.upload_control_unsupported': '当前任务路由暂不支持上传控件',
  'taskrouter.error.upload_resource_missing': '缺少可上传的资源',
  'taskrouter.error.tenant_unresolved': '未能解析租户信息',
  'taskrouter.error.supabase_session_failed': '获取 Supabase 会话失败: {{error}}',
  'taskrouter.status.preparing': '准备中...',
  'taskrouter.status.uploading': '上传图片中...',
  'taskrouter.status.validating': '验证表单中...',
  'taskrouter.status.creating': '正在创建任务...',
  'taskrouter.tab.editor': '运行',
  'taskrouter.tab.history': '历史记录',
  'taskrouter.history.importing': '正在导入历史图片...',
  'taskrouter.history.send_failed_resource': '创建文件资源失败',
  'taskrouter.history.send_failed_identifier': '资源标识符无效',
  'taskrouter.history.send_success': '图片已导入到画布',
  'taskrouter.history.select_prompt': '请选择一个历史任务',
  'taskrouter.history.duration_prefix': '耗时',
  'taskrouter.history.duration_unit': '秒',
  'taskrouter.history.createdAt': '创建时间',
  'taskrouter.history.charge': '扣除积分',
  'taskrouter.history.charge_value': '-{{value}}积分',
  'taskrouter.history.images': '输出预览',
  'taskrouter.history.retry': '重新加载',
  'taskrouter.history.id': '任务 ID',
  'taskrouter.history.message': '提示信息',
  'taskrouter.history.no_images': '暂无可预览图像',
  'taskrouter.history.client_missing': 'TaskRouter 客户端未初始化',
  'taskrouter.history.limit_notice': '当前版本限制获取最近10条',
  'taskrouter.history.refresh': '刷新',
  'taskrouter.history.detail_title': '任务详情',
  'taskrouter.history.loading': '加载历史任务...',
  'taskrouter.history.empty': '暂无历史任务',
  'taskrouter.history.started_at_label': '开始时间',
  'taskrouter.history.status.pending': '排队中',
  'taskrouter.history.status.running': '运行中',
  'taskrouter.history.status.completed': '已完成',
  'taskrouter.history.status.failed': '失败',
  'taskrouter.history.status.cancelled': '已取消',
  ...
  'comfy_simple.prompt_templates.button': '提示词预设',
  ...
  'comfy_simple.prompt_templates.modal_title': '提示词预设',
  'comfy_simple.prompt_templates.description': '管理 Comfy Simple 工作流的提示词片段。',
  'comfy_simple.prompt_templates.add_button': '新建模板',
  'comfy_simple.prompt_templates.search_placeholder': '搜索提示词预设',
  'comfy_simple.prompt_templates.use_button': '使用预设',
