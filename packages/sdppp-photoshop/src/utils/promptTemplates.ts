...
export function createComfyPromptInjection(
    ...
    if (!template) return { updates, restore }

    const add = (role: PromptRole, prompt: string | undefined) => {
